...
if __name__ == '__main__':
    ...
    entry_name = Entry(frame1, width=8)
    entry_name.place(relx=0.19, rely=0.115, anchor='s')

    label_num = Label(frame1, text="学号")
    label_num.place(relx=0.35, rely=0.11, anchor='s')
    entry_num = Entry(frame1, width=9)
    entry_num.place(relx=0.49, rely=0.115, anchor='s')
    button_import = Button(frame1, text="导入..", command=lambda: import_list(entry_num.get(), stu_info_columns))
    button_import.place(relx=0.625, rely=0.11, anchor='s')
    entry_num.bind('<Button-3>', lambda a: right_click(a, frame1, entry_num))

    label_sex = Label(frame1, text="性别")
    label_sex.place(relx=0.72, rely=0.11, anchor='s')
    entry_sex = Combobox(frame1, values=config['options_sex'], width=8)
    entry_sex.place(relx=0.85, rely=0.115, anchor='s')

    label_grade = Label(frame1, text="年级")
    label_grade.place(relx=0.07, rely=0.20, anchor='s')
    entry_grade = Entry(frame1, width=8)
    entry_grade.place(relx=0.19, rely=0.205, anchor='s')
    entry_grade.insert(END, entry_num.get())

    label_major = Label(frame1, text="专业")
    label_major.place(relx=0.35, rely=0.20, anchor='s')
    entry_major = Combobox(frame1, values=list(major_ch_en.keys()), width=22)
    entry_major.place(relx=0.625, rely=0.205, anchor='s')
    ...
    entry_name_en.place(relx=0.28, rely=0.295, anchor='s')

    label_major_en = Label(frame1, text="专业（英文）")
    label_major_en.place(relx=0.48, rely=0.29, anchor='s')
    entry_major_en = Combobox(frame1, values=list(major_ch_en.values()), width=18)
    entry_major_en.place(relx=0.735, rely=0.295, anchor='s')

    # 选择学生成绩表所在位置（单个文件）
    label_scores = Label(frame1, text="选择成绩表")
    label_scores.place(relx=0.1, rely=0.56, anchor='s')
    entry_scores = Entry(frame1, width=34)
    entry_scores.place(relx=0.5, rely=0.565, anchor='s')
    browse_button = Button(frame1, text="浏览..", command=lambda: open_file(entry_scores))
    browse_button.place(relx=0.88, rely=0.563, anchor='s')
    ...
    entry_stu_type.place(relx=0.27, rely=0.375, anchor='s')

    # 创建计算平均数的方式选项选择按钮
    option_calc_type = IntVar()
    label_type = Label(frame1, text="计分方式")
    label_type.place(relx=0.093, rely=0.452, anchor='s')
    Radiobutton(frame1, text="算数平均", variable=option_calc_type, value=1).place(relx=0.25, rely=0.453, anchor='s')
    Radiobutton(frame1, text="加权平均", variable=option_calc_type, value=2).place(relx=0.43, rely=0.453, anchor='s')
    ...
    entry_input_dir = Entry(frame2, width=29)
    entry_input_dir.insert(END, input_dir)
    entry_input_dir.place(relx=0.55, rely=0.161, anchor='s')
    browse_button_input_dir = Button(frame2, text="选择文件夹", command=lambda: open_directory(entry_input_dir))
    browse_button_input_dir.place(relx=0.91, rely=0.16, anchor='s')
    ...
    Radiobutton(frame2, text="算数平均", variable=option_calc_type_batch, value=1).place(relx=0.25, rely=0.253, anchor='s')
    Radiobutton(frame2, text="加权平均", variable=option_calc_type_batch, value=2).place(relx=0.43, rely=0.253, anchor='s')
    ...
    entry_stu_info_place_1.place(relx=0.382, rely=0.237, anchor='s')
    ...
    entry_stu_info_place_2.place(relx=0.636, rely=0.237, anchor='s')
    ...
    entry_stu_info_place_3.place(relx=0.887, rely=0.237, anchor='s')
    ...
    entry_stu_info_place_4.place(relx=0.368, rely=0.29, anchor='s')
    ...
    entry_stu_info_place_5.place(relx=0.62, rely=0.29, anchor='s')
    ...
    Radiobutton(frame3, text="Word文档", variable=option_output_format, value=1).place(relx=0.303, rely=0.53, anchor='s')
    # Radiobutton(frame3, text="PDF文档", variable=option_output_format, value=2).place(relx=0.476, rely=0.53, anchor='s')
    # Radiobutton(frame3, text="二者都输出", variable=option_output_format, value=3).place(relx=0.656, rely=0.53, anchor='s')

    # 如果需要增加或减少专业可以进行设置
    label_add_major = Label(frame3, text="增加或删除")
    label_add_major.place(relx=0.1, rely=0.61, anchor='s')
    label_add_major2 = Label(frame3, text="专业名称")
    label_add_major2.place(relx=0.095, rely=0.67, anchor='s')
    entry_add_major = Combobox(frame3, width=10, values=list(major_ch_en.keys()))
    entry_add_major.place(relx=0.268, rely=0.673, anchor='s')

    label_add_major_en = Label(frame3, text="英文名称（留空以删除）")
    label_add_major_en.place(relx=0.547, rely=0.67, anchor='s')
    entry_add_major_en = Entry(frame3, width=14)
    entry_add_major_en.place(relx=0.82, rely=0.672, anchor='s')
